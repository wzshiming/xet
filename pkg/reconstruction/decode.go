...
func NewReaderV1(ctx context.Context, client ClientAdapter, reconstruction *ReconstructionResponse, chunkCache map[xet.Hash][]byte) *ReaderV1 {
	return &ReaderV1{
		client:         client,
...
func NewReaderV2(ctx context.Context, client ClientAdapter, reconstruction *ReconstructionResponseV2, chunkCache map[xet.Hash][]byte) *ReaderV2 {
	return &ReaderV2{
		client:         client,
		chunkCache:     chunkCache,
		ctx:            ctx,
...
// ExpectedLength calculates the expected file length from V1 reconstruction
