...
// Grant is a permission optionally bound to one file (nil File / empty SHA256 = unbound); routes pass the grant they require, tokens carry the grant they convey.
type Grant struct {
